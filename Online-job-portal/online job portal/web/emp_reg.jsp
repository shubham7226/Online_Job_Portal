...
<HTML><HEAD><FONT SIZE="4"COLOR="blue" FACE="roman">JOB SEEKER LOGIN PAGE : 
</FONT>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<table width="100%" border="0" cellpadding="7" cellspacing="0" class="bg_white">
	  ...
	  <tr>
		  <td colspan="2" align="left" valign="top" class="border_green_btm bg_grey" style="padding:0px 10px 0px 0px;"><span class="txt_orange">                *</span>Required fields</td>

		</tr>
	  
<tr>
				<td width="400" align="right" bgcolor="#736AFF">ENTER LOGIN INFORMATION</td>
...
<tr>
				<td align="right" valign="top" bgcolor="#736AFF"><span class="txt_orange">*</span> Desired username:</td>
			  ...
			  <tr>
				...
				<td align="right" valign="top" bgcolor="#736AFF"><span class="txt_orange">*</span> Choose a password: </td>
				<td valign="top"  >
			  ...
			  <tr>
				<td align="right" valign="top" bgcolor="#736AFF"><span class="txt_orange">*</span> Re-enter password: </td>
				<td valign="top"  >
			...
			<tr>
				<td align="right" valign="top" bgcolor="#736AFF"><span class="txt_orange">* </span>
				Web address: </td>
...
<table cellspacing="0" cellpadding="0" border="0" id="currentloc_border">
				<tr><td>
				<BR>&nbsp<input type="submit" value="LOGIN">
				</table>
